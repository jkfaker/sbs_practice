...
<script>
	import uploadsHistory from '@/components/midTermBUploadsHistory/midTermBUploadsHistory.vue';
	export default {
		components: {
			uploadsHistory
		},
		data() {
			return {
				...
				uploadText: '！请上传《社会实践团队中期自查表》以及社会实践过程性材料,只能上传单个文件,如有多文件请打包上传', // 上传提示
